...
DECLARE_string(lin_control_command_topic);
DECLARE_string(control_test_topic);
...
DECLARE_string(req_state_transition_topic);
DECLARE_string(res_current_state_topic);
