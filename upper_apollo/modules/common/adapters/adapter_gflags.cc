...
DEFINE_string(lin_gps_topic, "/apollo/sensor/gnss/lin_odometry", "GPS topic name");
...
DEFINE_string(lin_control_command_topic, "/apollo/lin_control",
              "lin control command topic name");
DEFINE_string(control_test_topic, "/apollo/lin/control_test", 
              "lin added for testPublishMsg");
...
DEFINE_string(req_state_transition_topic, "/apollo/dreamview/ReqStateTransition",
              "request to change the state of state machine topic name");
DEFINE_string(res_current_state_topic, "/ResCurrentState",
              "the current state of state machine topic name");