...
namespace Microsoft.MixedReality.Toolkit.Diagnostics
{
    ...
    /// 
    /// </summary>
    [AddComponentMenu("Scripts/MRTK/Services/testVisualProfiler_Path")]
    public class testVisualProfiler_Path : MonoBehaviour
    {
        ...
        private static readonly int frameRange = 20;
        ...
        private static readonly string usedMemoryString = "Speed: ";
        private static readonly string peakMemoryString = "Peak: ";
        private static readonly string limitMemoryString = "Limit: ";
        private static readonly string voiceCommandString = "................";
        private static readonly string visualProfilerTitleString = "MRTK";
        ...
        private static readonly ProfilerMarker LateUpdatePerfMarker = new ProfilerMarker("[MRTK] testVisualProfiler_Path.LateUpdate");
        ...
        private void LateUpdate()
        {
            ...
            using (LateUpdatePerfMarker.Auto())
            {
                ...
                speed_data = (int)(Math.Abs(Math.Sin(t) * 40));

                if (elapsedSeconds >= frameSampleRate)
                {
                    int y;
                    y = (int)(Math.Abs(Math.Sin(t) * 40));

                    speed_data = y;

                    // int cpuFrameRate = (int)(1.0f / (elapsedSeconds / frameCount));
                    int cpuFrameRate = (int)y;
                    int gpuFrameRate = 0;
                ...
                if (ShouldShowProfiler && memoryStatsVisible)
                {
                    ...
                    if (limit != limitMemoryUsage)
                    {
                        if (WillDisplayedMemoryUsageDiffer(limitMemoryUsage, limit, displayedDecimalDigits))
                        {
                            ...
                            MemoryUsageToString(stringBuffer, displayedDecimalDigits, limitMemoryText, limitMemoryString, 50);
                        }
                    ...
                    if (usage != memoryUsage)
                    {
                        ...
                        //usedAnchor.localScale = new Vector3((float)speed_data / 50, usedAnchor.localScale.y, usedAnchor.localScale.z);
                        usedAnchor.localScale = new Vector3((float)30 / 50, usedAnchor.localScale.y, usedAnchor.localScale.z);
                        ...
                        if (WillDisplayedMemoryUsageDiffer(memoryUsage, usage, displayedDecimalDigits))
                        {
                            ...
                            MemoryUsageToString(stringBuffer, displayedDecimalDigits, usedMemoryText, usedMemoryString, (ulong)speed_data);
                        }
                    ...
                    if (memoryUsage > peakMemoryUsage)
                    {
                        ...
                        if (WillDisplayedMemoryUsageDiffer(peakMemoryUsage, memoryUsage, displayedDecimalDigits))
                        {
                            ...
                            MemoryUsageToString(stringBuffer, displayedDecimalDigits, peakMemoryText, peakMemoryString, peak_data);
                        }
        ...
        private static readonly ProfilerMarker CalculateWindowPositionPerfMarker = new ProfilerMarker("[MRTK] testVisualProfiler_Path.CalculateWindowPosition");
        ...
        private static readonly ProfilerMarker CalculateWindowRotationPerfMarker = new ProfilerMarker("[MRTK] testVisualProfiler_Path.CalculateWindowRotation");
            ...
            using (CalculateWindowRotationPerfMarker.Auto())
            {
                ...
                switch (windowAnchor)
                {
                    ...
                    case TextAnchor.LowerCenter: 
                        rotation *= windowHorizontalRotation;
                        rotation *= Quaternion.Euler(-20.0f,0.0f,0.0f);
                        break;
        ...
        private static readonly ProfilerMarker CalculateFrameColorPerfMarker = new ProfilerMarker("[MRTK] testVisualProfiler_Path.CalculateFrameColor");
        ...
        private static readonly ProfilerMarker CalculateBackgroundSizePerfMarker = new ProfilerMarker("[MRTK] testVisualProfiler_Path.CalculateBackgroundSize");
        ...
        private void BuildWindow()
        {
            ...
            // Add frame rate text and frame indicators.
            {
                ...
                frameInfoColors[0] = CalculateFrameColor((int)0);
                frameInfoColors[1] = CalculateFrameColor((int)0);
                frameInfoColors[2] = CalculateFrameColor((int)0);
                frameInfoColors[3] = CalculateFrameColor((int)0);
        ...
        private void BuildFrameRateStrings()
        {
            ...
            for (int i = 0; i < cpuFrameRateStrings.Length; ++i)
            {
               ...
               // milisecondStringBuilder.AppendFormat(displayedDecimalFormat, miliseconds);
                ...
                //stringBuilder.AppendFormat("speed: {0} km/h", i.ToString());

                double battery_date = 85; 
                stringBuilder.AppendFormat("Battery: {0}%", battery_date.ToString());
        ...
        private static readonly ProfilerMarker MemoryUsageToStringPerfMarker = new ProfilerMarker("[MRTK] testVisualProfiler_Path.MemoryUsageToString");
        ...
        private static void MemoryUsageToString(char[] stringBuffer, int displayedDecimalDigits, TextMesh textMesh, string prefixString, ulong memoryUsage)
        {
            using (MemoryUsageToStringPerfMarker.Auto())
            {
                ...
                memoryUsageFractionalDigits = (int)memoryUsage;
                ...
                stringBuffer[bufferIndex++] = '/';
                stringBuffer[bufferIndex++] = 'h';

                textMesh.text = new string(stringBuffer, 0, bufferIndex);
            }
        }

        private static readonly ProfilerMarker MemoryItoAPerfMarker = new ProfilerMarker("[MRTK] testVisualProfiler_Path.MemoryItoA");
        ...
        private static readonly ProfilerMarker AverageFrameTimingPerfMarker = new ProfilerMarker("[MRTK] testVisualProfiler_Path.AverageFrameTiming");
        ...
        private static readonly ProfilerMarker WillDisplayedMemoryUsageDifferPerfMarker = new ProfilerMarker("[MRTK] testVisualProfiler_Path.WillDisplayedMemoryUsageDiffer");
