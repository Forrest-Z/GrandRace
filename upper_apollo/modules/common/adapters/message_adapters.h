...
#include "modules/control/proto/lin_control_cmd.pb.h"
...
using LinControlCommandAdapter = Adapter<control::LinControlCommand>;
using GpsAdapter = Adapter<apollo::localization::Gps>;
using Lin_GpsAdapter = Adapter<apollo::localization::Gps>;
...
using ReqStateTransitionAdapter = Adapter<::std_msgs::UInt8>;
using ResCurrentStateAdapter = Adapter<::std_msgs::UInt8>;
}  // namespace adapter
}  // namespace common
}  // namespace apollo
