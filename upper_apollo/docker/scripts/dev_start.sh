...
#VERSION_AARCH64="dev-aarch64-20180830_0845"
#VERSION_OPT="dev-aarch64-20180830_0845"

VERSION_AARCH64="dev-aarch64-20180929_1320"
VERSION_OPT="dev-aarch64-20180929_1320"

#dev-aarch64-20180929_1320
#VERSION_AARCH64="dev-aarch64-20180917_1910"
#VERSION_OPT="dev-aarch64-20180917_1910"
...
#    docker pull ${YOLO3D_VOLUME_IMAGE}
    ...
    if [ "${USER}" != "root" ]; then
	#execute 'docker_adduser.sh' using 'root', it's necessary or will run into permission denied
