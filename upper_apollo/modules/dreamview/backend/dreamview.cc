...
void Dreamview::CheckAdapters() {
  ...
  CHECK(AdapterManager::GetResCurrentState())
      << "ResCurrentStateAdapter is not initialized.";
  CHECK(AdapterManager::GetReqStateTransition())
      << "ReqStateTransitionAdapter is not initialized.";      
}
