  ...
  for (const auto &config : configs.config()) {
    switch (config.type()) {
      ...
      case AdapterConfig::GPS:
        ...
        break;
      case AdapterConfig::LIN_GPS:
        EnableLin_Gps(FLAGS_lin_gps_topic, config);
        break;
      ...
      case AdapterConfig::CONTROL_COMMAND:
        ...
        break;
      case AdapterConfig::LIN_CONTROL_COMMAND:
        EnableLinControlCommand(FLAGS_lin_control_command_topic, config);
        break; 
      ...
      case AdapterConfig::VELODYNE_SCAN_SPARSE_3:
        ...
        break;
      case AdapterConfig::RES_CURRENT_STATE:
        EnableResCurrentState(FLAGS_res_current_state_topic, config);
        break;
      case AdapterConfig::REQ_STATE_TRANSITION:
        EnableReqStateTransition(FLAGS_req_state_transition_topic, config);
        break;
